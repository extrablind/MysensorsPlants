/*   Il s'agit du code d'exemple de la librairie Radiohead
 *    nrf24_reliable_datagram_client.pde
 *    Avec seulement comme changement l'adressage des pin CE et CSN 
 *    dans l'instanciation de NRF24 driver (lignes 25, 26)
Adrien
*/
